 ...
 * @author tom.watteny
 */
@WebServlet(name = "Registersuccessful", urlPatterns = {"/registersuccessful.php"})
public class registersuccessful extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<link rel='stylesheet' href='assets/css/registersuccesful.css'/>");
            out.println("<title>Registration succesful</title>");            
            out.println("</head>");
            out.println("<body>");
